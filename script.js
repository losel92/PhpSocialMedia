...
function postEditPopUp(){
    ...
    var editHead = $('#'+lastClickedPost).children('.post-contents').children('.post-headline').text();
    var editContents = $('#'+lastClickedPost).children('.post-contents').children('.post-text').text();
